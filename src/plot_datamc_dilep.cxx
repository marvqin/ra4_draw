...
int main(){
  ...
  //2015 Samples
  auto tt1l_2015 = Proc<Baby_full>("t#bar{t} (1l)", Process::Type::background, colors("tt_1l"),
    {mc_2015+"*_TTJets*Lept*.root", mc_2015+"*_TTJets_HT*.root"}, "ntruleps<=1&&stitch");
  auto tt2l_2015 = Proc<Baby_full>("t#bar{t} (2l)", Process::Type::background, colors("tt_2l"),
    {mc_2015+"*_TTJets*Lept*.root", mc_2015+"*_TTJets_HT*.root"}, "ntruleps>=2&&stitch");
  auto wjets_2015 = Proc<Baby_full>("W+jets", Process::Type::background, colors("wjets"),
    {mc_2015+"*_WJetsToLNu*.root"});
  auto single_t_2015 = Proc<Baby_full>("Single t", Process::Type::background, colors("single_t"),
    {mc_2015+"*_ST_*.root"});
  auto ttv_2015 = Proc<Baby_full>("t#bar{t}V", Process::Type::background, colors("ttv"),
  ...
  //2016 Samples
  auto tt1l_2016 = Proc<Baby_full>("t#bar{t} (1l)", Process::Type::background, colors("tt_1l"),
    {mc_2016+"*_TTJets*Lept*.root", mc_2016+"*_TTJets_HT*.root"}, "ntruleps<=1&&stitch");
  auto tt2l_2016 = Proc<Baby_full>("t#bar{t} (2l)", Process::Type::background, colors("tt_2l"),
    {mc_2016+"*_TTJets*Lept*.root", mc_2016+"*_TTJets_HT*.root"}, "ntruleps>=2&&stitch");
  auto wjets_2016 = Proc<Baby_full>("W+jets", Process::Type::background, colors("wjets"),
    {mc_2016+"*_WJetsToLNu*.root"});
  auto single_t_2016 = Proc<Baby_full>("Single t", Process::Type::background, colors("single_t"),
    {mc_2016+"*_ST_*.root"});
  auto ttv_2016 = Proc<Baby_full>("t#bar{t}V", Process::Type::background, colors("ttv"),
