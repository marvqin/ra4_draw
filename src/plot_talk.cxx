...
int main(){
  ...
  for(int ilep=2; ilep<3; ilep++){
    ...
    pm.Push<HistoStack>(HistoDef({15, 500, 2000., "ht", "H_{T} [GeV]", {500.}},
                                 lepcut+"&&njets>=5&&nbm>=1", "weight"),
                        full_trig_skim_1l, all_plot_types);
    pm.Push<HistoStack>(HistoDef({10, 200, 500., "met", "E_{T}^{miss} [GeV]", {200., 350., 500.}},
                                 lepcut+"&&njets>=5&&nbm>=1", "weight"),
                        full_trig_skim_1l, all_plot_types);
    ...
    pm.Push<HistoStack>(HistoDef({16, 0., 280., "mt", "m_{T} [GeV]", {140.}},
                                 lepcut+"&&njets>=5&&nbm>=1", "weight"),
                        full_trig_skim_1l, all_plot_types);
    ...
    pm.Push<HistoStack>(HistoDef({10, 0., 1500., "mj14", "M_{J} [GeV]", {400.}},
                                 lepcut+"&&njets>=5&&nbm>=1", "weight"),
                        full_trig_skim_1l, all_plot_types);
  ...
  pm.Push<HistoStack>(HistoDef({10, 0., 1000., "mj14", "M_{J} [GeV]", {400.}},
                               "nels==1&&nmus==1&&ht>300&&met>100&&njets>=2&&met<400&&nbm<3&&nbm>=1&&((leps_pt[0]>30&&leps_eta[0]<2.1&&leps_eta[0]>-2.1)||(leps_pt[1]>30&&leps_eta[1]<2.1&&leps_eta[1]>-2.1))", "weight"),
