...
int main(){
    ...
    for(int inveto=0; inveto<2; inveto++){
      ...
      for(int injets=0; injets<2; injets++){
        ...
        for(int inb=0; inb<2; inb++){
          ...
          //
          pm.Push<HistoStack>(HistoDef({15, 500, 2000., "ht", "H_{T} [GeV]", {500.}},
                                       lepcut+"&&"+lowmtcut+"&&"+njetscut+"&&"+nbcut+"&&"+nvetocut, "weight"),
                              full_trig_skim_1l, all_plot_types);
          pm.Push<HistoStack>(HistoDef({10, 200, 700., "met", "E_{T}^{miss} [GeV]", {200., 350., 500.}},
                                       lepcut+"&&"+lowmtcut+"&&"+njetscut+"&&"+nbcut+"&&"+nvetocut, "weight"),
                              full_trig_skim_1l, all_plot_types);
          pm.Push<HistoStack>(HistoDef({10, 200, 700., "met", "E_{T}^{miss} [GeV]", {200., 350., 500.}},
                                       lepcut+"&&"+lowmjcut+"&&"+njetscut+"&&"+nbcut+"&&"+nvetocut, "weight"),
                              full_trig_skim_1l, all_plot_types);
          pm.Push<HistoStack>(HistoDef({16, -0.5, 15.5, "njets", "N_{jets}", {5.5, 8.5}},
                                       lepcut+"&&"+lowmtcut+"&&"+nbcut+"&&"+nvetocut, "weight"),
                              full_trig_skim_1l, all_plot_types);
          pm.Push<HistoStack>(HistoDef({7, -0.5, 6.5, "nbm", "N_{b}", {0.5, 1.5, 2.5}},
                                       lepcut+"&&"+lowmtcut+"&&"+njetscut+"&&"+nvetocut, "weight"),
                              full_trig_skim_1l, all_plot_types);
          pm.Push<HistoStack>(HistoDef({14, 0., 280., "mt", "m_{T} [GeV]", {140.}},
                                       lepcut+"&&"+lowmtcut+"&&"+njetscut+"&&"+nbcut+"&&"+nvetocut, "weight"),
                              full_trig_skim_1l, all_plot_types);
          pm.Push<HistoStack>(HistoDef({14, 0., 280., "mt", "m_{T} [GeV]", {140.}},
                                       lepcut+"&&"+lowmjcut+"&&"+njetscut+"&&"+nbcut+"&&"+nvetocut, "weight"),
                              full_trig_skim_1l, all_plot_types);
          pm.Push<HistoStack>(HistoDef({14, 0., 280., "mt", "m_{T} [GeV]", {140.}},
                                       lepcut+"&&"+lowmtcut+"&&"+njetscut+"&&nbm==0"+"&&"+nvetocut, "weight"),
                              full_trig_skim_1l, all_plot_types);

          if(ilep==0){
            // only barrel or endcap electron
            pm.Push<HistoStack>(HistoDef({10, 200, 700., "met", "E_{T}^{miss} [GeV]", {200., 350., 500.}},
                                         lepcut+"&&"+lowmtcut+"&&"+njetscut+"&&"+nbcut+"&&"+nvetocut+"&&(leps_eta[0]<1.479&&leps_eta[0]>-1.479)", "weight"),
                                full_trig_skim_1l, all_plot_types);
            pm.Push<HistoStack>(HistoDef({10, 200, 700., "met", "E_{T}^{miss} [GeV]", {200., 350., 500.}},
                                         lepcut+"&&"+lowmtcut+"&&"+njetscut+"&&"+nbcut+"&&"+nvetocut+"&&(leps_eta[0]>1.479||leps_eta[0]<-1.479)", "weight"),
                                full_trig_skim_1l, all_plot_types);
          ...
          pm.Push<HistoStack>(HistoDef({10, 30, 630., "jets_pt[0]", "p_{T}(leading jet) [GeV]"},
                                       lepcut+"&&"+lowmtcut+"&&"+njetscut+"&&"+nbcut+"&&"+nvetocut+"&&(!jets_islep[0])", "weight"),
                              full_trig_skim_1l, all_plot_types);
          ...
          pm.Push<HistoStack>(HistoDef({10, 30, 630., "jets_pt", "p_{T}(jet) [GeV]"},
                                       lepcut+"&&"+lowmtcut+"&&"+njetscut+"&&"+nbcut+"&&"+nvetocut+"&&(!jets_islep)", "weight"),
                              full_trig_skim_1l, all_plot_types);
          ...
          pm.Push<HistoStack>(HistoDef({10, 0, 500., "fjets14_m[0]", "m_{J1} [GeV]"},
                              ...
                              full_trig_skim_1l, all_plot_types);
          pm.Push<HistoStack>(HistoDef({10, 0, 500., "fjets14_m[0]", "m_{J1} [GeV]"},
                                       lepcut+"&&"+lowmtcut+"&&"+njetscut+"&&"+nbcut+"&&"+nvetocut+"&&leps_pt[0]>160", "weight"),
                              full_trig_skim_1l, all_plot_types);
          pm.Push<HistoStack>(HistoDef({10, 0, 500., "fjets14_m[0]", "m_{J1} [GeV]"},
                                       lepcut+"&&"+lowmtcut+"&&"+njetscut+"&&"+nbcut+"&&"+nvetocut+"&&leps_pt[0]<=160", "weight"),
                              full_trig_skim_1l, all_plot_types);
          ...
          pm.Push<HistoStack>(HistoDef({20, 0., 400., "fjets14_m[0]", "m_{J1} [GeV]"},
                                       lepcut+"&&"+lowmtcut+"&&njets<=5&&nbm>=1", "weight"),
                              full_trig_skim_1l, all_plot_types);

          // event-level variables related to fatjet
          pm.Push<HistoStack>(HistoDef({15, 0., 1500., "mj14", "M_{J} [GeV]", {400.}},
                                       lepcut+"&&"+lowmtcut+"&&"+njetscut+"&&"+nbcut+"&&"+nvetocut, "weight"),
                              full_trig_skim_1l, all_plot_types);
  ...
  // 0-lepton events
  //
  pm.Push<HistoStack>(HistoDef({30, 0., 1500., "mj14", "M_{J} [GeV]", {400.}},
                               "nleps==0&&met<50&&ht>1000&&njets>=4&&njets<=5", "weight"),
                      full_trig_skim_0l, all_plot_types);
  pm.Push<HistoStack>(HistoDef({30, 0., 500., "fjets14_m", "m_{J} [GeV] [GeV]", {400.}},
                               "nleps==0&&met<50&&ht>1000&&njets>=4&&njets<=5", "weight"),
                      full_trig_skim_0l, all_plot_types);

  pm.Push<HistoStack>(HistoDef({30, 0., 1500., "mj14", "M_{J} [GeV]", {400.}},
                               "nleps==0&&met<50&&ht>1000&&njets>=6&&njets<=8", "weight"),
                      full_trig_skim_0l, all_plot_types);
  pm.Push<HistoStack>(HistoDef({30, 0., 500., "fjets14_m", "m_{J} [GeV]", {400.}},
                               "nleps==0&&met<50&&ht>1000&&njets>=6&&njets<=8", "weight"),
                      full_trig_skim_0l, all_plot_types);

  pm.Push<HistoStack>(HistoDef({30, 0., 1500., "mj14", "M_{J} [GeV]", {400.}},
                               "nleps==0&&met<50&&ht>1000&&njets>=9", "weight"),
                      full_trig_skim_0l, all_plot_types);
  pm.Push<HistoStack>(HistoDef({30, 0., 500., "fjets14_m", "m_{J} [GeV]", {400.}},
                               "nleps==0&&met<50&&ht>1000&&njets>=9", "weight"),
                      full_trig_skim_0l, all_plot_types);
  ...
  // ttbar
  pm.Push<HistoStack>(HistoDef({15, 0., 1500., "mj14", "M_{J} [GeV]", {400.}},
                               "nels==1&&nmus==1&&ht>300&&met>100&&njets>=2&&njets<=3&&met<400&&nbm<3&&nbm>=1&&((leps_pt[0]>30&&leps_eta[0]<2.1&&leps_eta[0]>-2.1)||(leps_pt[1]>30&&leps_eta[1]<2.1&&leps_eta[1]>-2.1))", "weight"),
                      full_trig_skim_2l, all_plot_types);
  pm.Push<HistoStack>(HistoDef({15, 0., 500., "fjets14_m", "m_{J} [GeV]", {400.}},
                               "nels==1&&nmus==1&&ht>300&&met>100&&njets>=2&&njets<=3&&met<400&&nbm<3&&nbm>=1&&((leps_pt[0]>30&&leps_eta[0]<2.1&&leps_eta[0]>-2.1)||(leps_pt[1]>30&&leps_eta[1]<2.1&&leps_eta[1]>-2.1))", "weight"),
                      full_trig_skim_2l, all_plot_types);
  pm.Push<HistoStack>(HistoDef({15, 0., 1500., "mj14", "M_{J} [GeV]", {400.}},
                               "nels==1&&nmus==1&&ht>300&&met>100&&njets>=4&&met<400&&nbm<3&&nbm>=1&&((leps_pt[0]>30&&leps_eta[0]<2.1&&leps_eta[0]>-2.1)||(leps_pt[1]>30&&leps_eta[1]<2.1&&leps_eta[1]>-2.1))", "weight"),
                      full_trig_skim_2l, all_plot_types);
  pm.Push<HistoStack>(HistoDef({15, 0., 500., "fjets14_m", "m_{J} [GeV]", {400.}},
                               "nels==1&&nmus==1&&ht>300&&met>100&&njets>=4&&met<400&&nbm<3&&nbm>=1&&((leps_pt[0]>30&&leps_eta[0]<2.1&&leps_eta[0]>-2.1)||(leps_pt[1]>30&&leps_eta[1]<2.1&&leps_eta[1]>-2.1))", "weight"),
                      full_trig_skim_2l, all_plot_types);
  // DY
  pm.Push<HistoStack>(HistoDef({15, 0., 1500., "mj14", "M_{J} [GeV]", {400.}},
                               "(nmus>=2||nels>=2)&&ht>350&&njets>=2&&njets<=3&&"+mllcut, "weight"),
                      full_trig_skim_2l, all_plot_types);
  pm.Push<HistoStack>(HistoDef({15, 0., 500., "fjets14_m", "m_{J} [GeV]", {400.}},
                               "(nmus>=2||nels>=2)&&ht>350&&njets>=2&&njets<=3&&"+mllcut, "weight"),
                      full_trig_skim_2l, all_plot_types);
  pm.Push<HistoStack>(HistoDef({15, 0., 1500., "mj14", "M_{J} [GeV]", {400.}},
                               "(nmus>=2||nels>=2)&&ht>350&&njets>=4&&"+mllcut, "weight"),
                      full_trig_skim_2l, all_plot_types);
  pm.Push<HistoStack>(HistoDef({15, 0., 500., "fjets14_m", "m_{J} [GeV]", {400.}},
                               "(nmus>=2||nels>=2)&&ht>350&&njets>=4&&"+mllcut, "weight"),
                      full_trig_skim_2l, all_plot_types);
